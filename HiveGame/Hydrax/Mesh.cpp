		...
		if (mCreated)
		{
			...
			else
			{
				meshBounds = Ogre::AxisAlignedBox(0,                     -Options.MeshStrength/2, 0,
			                                      Ogre::Real(Options.MeshSize.Width), Options.MeshStrength/2, Ogre::Real(Options.MeshSize.Height));
			}
	...
	void Mesh::create()
	{
		...
		else
		{
			meshBounds = Ogre::AxisAlignedBox(0,                      -mOptions.MeshStrength/2, 0,
			                                  Ogre::Real(mOptions.MeshSize.Width), mOptions.MeshStrength/2, Ogre::Real(mOptions.MeshSize.Height));
		}
