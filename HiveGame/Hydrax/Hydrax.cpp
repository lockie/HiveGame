...
namespace Hydrax
{
	...
	Hydrax::Hydrax(Ogre::SceneManager *sm, Ogre::Camera *c, Ogre::Viewport *v)
            ...
            , mPlanesError(0)
            , mFullReflectionDistance(99999997952)
            , mGlobalTransparency(0.05f)
			, mWaterColor(Ogre::Vector3(0,0.1f,0.172f))
            , mNormalDistortion(0.09f)
            , mSunPosition(Ogre::Vector3(5000,3000,1))
            , mSunStrength(1.75f)
            , mSunArea(150)
            , mSunColor(Ogre::Vector3(1,0.75f,0.25f))
            ...
            , mCausticsPower(15)
            , mCausticsEnd(0.55f)
			, mGodRaysExposure(Ogre::Vector3(0.76f,2.46f,2.29f))
