...
void PortalEditor::createProperties(Ogitors::OgitorsPropertyValueMap &params)
{
	...
	//PROPERTY_PTR(mZone, "zone", Ogre::String, "", 0, SETTER(Ogre::String, PortalEditor, _setZone));
...
Ogre::Entity* PortalEditor::_createPlane()
{
    ...
    mesh = Ogre::MeshManager::getSingletonPtr()->createPlane(mName->get(),"ProjectResources",plane,mWidth->get(),mHeight->get());
