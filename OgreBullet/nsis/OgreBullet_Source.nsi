...
!define PKG_NAME "${BASE_NAME}_Source"
...
Section "${PKG_NAME} (required)"
  ...
  File /r /x *.pch /x *.sbr /x *.bsc /x *.exp /x *.lib /x BuildLog.htm /x nsis /x *.exe /x *.svn /x CVS /x *.res /x *.user /x *.obj /x *.ncb  /x *.bat /x *.idb /x *.pdb /x *.ilk /x *.dep /x *.dll /x *.manifest "..\*.*"
