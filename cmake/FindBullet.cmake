...
find_path(BULLET_CONVEX_DECOMPOSITION_INCLUDE_DIR NAMES ConvexBuilder.h
  HINTS
    ...
    ${BULLET_ROOT}/src
	${BULLET_ROOT}/Extras
  PATH_SUFFIXES ConvexDecomposition
)
...
_FIND_BULLET_LIBRARY(BULLET_CONVEX_DECOMPOSITION_LIBRARY        ConvexDecomposition)
_FIND_BULLET_LIBRARY(BULLET_CONVEX_DECOMPOSITION_LIBRARY_DEBUG  ConvexDecomposition_d)
...
FIND_PACKAGE_HANDLE_STANDARD_ARGS(Bullet DEFAULT_MSG
    ...
    BULLET_SOFTBODY_LIBRARY BULLET_CONVEX_DECOMPOSITION_LIBRARY BULLET_INCLUDE_DIR)

set(BULLET_INCLUDE_DIRS ${BULLET_INCLUDE_DIR} ${BULLET_CONVEX_DECOMPOSITION_INCLUDE_DIR})
if(BULLET_FOUND)
   _BULLET_APPEND_LIBRARIES(BULLET_LIBRARIES BULLET_DYNAMICS_LIBRARY)
   _BULLET_APPEND_LIBRARIES(BULLET_LIBRARIES BULLET_COLLISION_LIBRARY)
   _BULLET_APPEND_LIBRARIES(BULLET_LIBRARIES BULLET_MATH_LIBRARY)
   _BULLET_APPEND_LIBRARIES(BULLET_LIBRARIES BULLET_SOFTBODY_LIBRARY)
   _BULLET_APPEND_LIBRARIES(BULLET_LIBRARIES BULLET_CONVEX_DECOMPOSITION_LIBRARY)
endif()
