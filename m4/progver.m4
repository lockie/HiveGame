...
export AS_TR_SH([cs_cv_prog_$4_version_$2_ok])=''
CS_VCHK_RUNTH([CS_VCHK_PATCOUNT([$3])],
[test -z `eval echo $AS_TR_SH([cs_cv_prog_$4_version_$2_ok])` \
...
AS_IF([test `eval echo $AS_TR_SH([cs_cv_prog_$4_version_$2_ok])` = yes],
    [AS_TR_SH([cs_prog_$4_version_ok])=yes],
    [AS_TR_SH([cs_prog_$4_version_ok])=no])
export AS_TR_SH([cs_cv_prog_$4_version_$2_ok_annotated])="$AS_TR_SH([cs_cv_prog_$4_version_$2_ok])"
AS_IF([test -n `eval echo $cs_prog_$4_is_version`],
    [export AS_TR_SH([cs_cv_prog_$4_version_$2_ok_annotated])="$AS_TR_SH([cs_cv_prog_$4_version_$2_ok_annotated]) (version $cs_prog_$4_is_version)"
